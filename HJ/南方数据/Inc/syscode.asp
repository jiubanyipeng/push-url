...
'=================================================
sub ShowClassGuide()
	response.write  "|&nbsp;<a href='Products.asp'>研发与产品</a>&nbsp;&gt;&gt;"
...
sub ShowArticle(TitleLen)
	...
	sqlArticle=sqlArticle & " ArticleID,Product_Id,BigClassName,SmallClassName,IncludePic,Title,Spec,Unit,Memo,DefaultPicUrl,UpdateTime,Hits from Product where Passed=True "
	...
	do while not rsArticle.eof
		...
		strTemp= strTemp & "<table width=100% border=0 cellspacing=3 cellpadding=0>"
              ...
              '  strTemp= strTemp & "</tr><tr>"
				...
				strTemp= strTemp & "<td width=50% height=12>"
                strTemp= strTemp & "<div align=center><a href='javascript:eshop(" & rsArticle("Product_Id") & ")'><img border=0 src=img/addtocart.gif width=100 height=26>"
                strTemp= strTemp & "</a></div></td>"
