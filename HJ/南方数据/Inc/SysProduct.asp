...
'=================================================
sub ShowClassGuide()
	response.write  "&nbsp;<a href='Products.asp'>产品</a>&nbsp;&gt;&gt;"
...
sub ProductContent(intTitleLen)
   ...
   strTemp= strTemp & "<a href=ProductShow.asp?ID=" & rsProduct("id") & ">" & "<img src=" & rsProduct("DefaultPicUrl") & " width='120' height='120' border='0'>" & "</a><br></div>"  
   strTemp= strTemp & "</td>"
...
sub SearchResultContent()
   ...
   strTemp= strTemp &"<TD background='Img/bg_03.gif' width=10>&nbsp;</TD>"
   strTemp= strTemp & "<td>"&"<div align=center>"
   strTemp= strTemp & "<a href=ProductShow.asp?ID=" & rsSearch("id") & ">" & "<img src=" & rsSearch("DefaultPicUrl") & " width='120' height='120' border='0'>" & "</a><br></div>"  
   strTemp= strTemp & "</td>"
   strTemp= strTemp &"<TD background='Img/bg_04.gif' width=10>&nbsp;</TD>"
   strTemp= strTemp &"</TR>"
   strTemp= strTemp &"<TR>"
