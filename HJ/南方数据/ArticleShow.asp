...
%> </TD>
                  <TD width="106"><a href='javascript:eshop(<%=rs("Product_Id")%>)'><img border=0 src=Img/addtocart.gif 
...
width=100 height=26></a></TD>
              ...
              width=10></TD>
                ...
                <TR> 
                  <TD height="1" colspan="3"><br> <%call ShowArticleContent()%> </TD>
                </TR>
                <TR> 
                  <TD 
                  height=1 colspan="3" background=img/naBialym.gif><IMG height=1 src="img/1x1_pix.gif" 
              width=10></TD>
                ...
                <TR> 
                  ...
                  <TD 
                  height=25><a href='javascript:eshop(<%=rs("Product_Id")%>)'><img border=0 src=Img/addtocart.gif 
