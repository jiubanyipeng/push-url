...
rs.update
rs.close
response.redirect "Manage_Main4.asp"
end if
sql="select * from main"
  ...
  <tr> 
	...
	<br>
      ...
      <table width="550" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td height="25">
<div align="center"><strong>联 系 信 息 设 置</strong></div></td>
        </tr>
        <tr> 
          <form method="POST" action="Manage_Main4.asp?no=eshop">
		  <td><table width="100%" border="0" cellspacing="2" cellpadding="0">
                <tr> 
                  <td height="30" colspan="2">&nbsp;</td>
                </tr>
                <tr> 
                  <td width="19%" height="300" bgcolor="#C0C0C0"> <div align="center"><br>
                      支持UBB代码 </div></td>
