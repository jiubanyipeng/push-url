...
%>
                <tr bgcolor="#ECF5FF"> 
                  ...
                  <td> <div align="center"><img name="" src="../<%=rs("CompHonor")%>" width="100" height="120" alt=""></div></td>
                  <td> 
                    <div align="center"><a href="Admin_HonorEdit.asp?id=<%=rs("id")%>">修改</a></div></td>
                  <td> 
                    <div align="center"><a href="Admin_Honor.asp?id=<%=rs("id")%>&mark=southidc" onclick="return ConfirmDel();">删除</a></div></td>
                </tr>
                <% 
i=i+1 
