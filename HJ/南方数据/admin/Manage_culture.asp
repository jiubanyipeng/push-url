  ...
  <tr> 
	...
	<br>
      ...
      <table width="550" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td height="25"> <div align="center"><strong>企业文化<br>
              <br>
              </strong></div></td>
        </tr>
        <tr> 
            <td><div align="center"> 
              <table width="100%" border="0" cellspacing="2" cellpadding="3">
                <tr bgcolor="#C0C0C0"> 
                  ...
                  <td width="62%"> <div align="center">标题</div></td>
...
%>
                <tr bgcolor="#E3E3E3"> 
                  ...
                  <td>&nbsp;&nbsp;<%=rs("title")%></td>
                  <td> <div align="center"><a href=../cultureNewsInfo.asp?Id=<%=rs("id")%> target="_blank">查看</a></div></td>
                  <td bgcolor="#E3E3E3"> 
                    <div align="center"><a href="Manage_editculturenews.asp?id=<%=rs("id")%>">修改</a></div></td>
                  <td> <div align="center"><a href="Manage_culture.asp?id=<%=rs("id")%>&amp;no=eshop">删除</a></div></td>
                </tr>
                <% 
i=i+1 
