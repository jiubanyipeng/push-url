                ...
                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                  <tr bgcolor="#ECF5FF"> 
                    ...
                    <td width="62%" bgcolor="#ECF5FF"> 
                      <textarea name="explain" cols="40" rows="8"><%=rs("explain")%></textarea>
                    </td>
                  </tr>
                  <tr bgcolor="#ECF5FF"> 
                    <td height="22"> 
                      <div align="center">证书图片</div></td>
                    <td> 
                      <input name="CompHonor" type="text" value="<%=rs("CompHonor")%>" size="40" maxlength="50"> 
