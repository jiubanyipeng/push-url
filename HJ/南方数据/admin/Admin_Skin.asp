...
<table width="600" border="0" align="center" cellpadding="2" cellspacing="1" class="table_southidc">
  <tr class="topbg"> 
    <td class="back_southidc" height="22" colspan="2" align="center"><strong>配 
      色 模 板 管 理</strong></td>
  </tr>
  <tr class="tdbg"> 
...
<form name="form1" method="post" action="Admin_Skin.asp">
  ...
  do while not rs.EOF %>
    <tr class="tdbg" onmouseout="this.style.backgroundColor=''" onmouseover="this.style.backgroundColor='#BFDFFF'"> 
      <td width="32" align="center"><input type="radio" value="<%=rs("SkinID")%>" <%if rs("IsDefault")=true then response.write " checked"%> name="SkinID"></td>
      <td width="31" align="center"><%=rs("SkinID")%></td>
      <td align="center"><%=rs("SkinName")%></td>
      <td width="129" align="center"><%response.write "<a href='Admin_Skin.asp?Action=Prview&SkinID=" & rs("SkinID") & "' title='点此查看原始效果图'><img src='" & rs("PicUrl") & "' width=100 height=30 border=0></a>"%></td>
      <td width="64" align="center"><%response.write "<a href='mailto:" & rs("DesignerEmail") & "' title='设计者信箱：" & rs("DesignerEmail") & vbcrlf & "设计者主页：" & rs("DesignerHomepage") & "'>" & rs("DesignerName") & "</a>"%></td>
      <td width="82" align="center"><%if rs("DesignType")=1 then response.write "用户自定义" else response.write "系统提供"%></td>
...
<form name="myform" method="post" action="Admin_Skin.asp">
  ...
  do while not rs.EOF %>
    <tr class="tdbg" onmouseout="this.style.backgroundColor=''" onmouseover="this.style.backgroundColor='#BFDFFF'"> 
      <td width="39" align="center"><input type="checkbox" value="<%=rs("SkinID")%>" name="SkinID" onclick="unselectall()"></td>
...
<form name="form1" method="post" action="Admin_Skin.asp">
  <table width="600" border="0" align="center" cellpadding="2" cellspacing="1" class="border">
    ...
    <tr class="tdbg"> 
      <td><p><strong><font color="#FF0000">文本框的CSS定义</font></strong><br>
    ...
    <tr class="tdbg"> 
      <td><strong>标题文字的CSS定义</strong><br>
    ...
    <tr class="tdbg"> 
      <td><strong>内容单元格的CSS定义</strong><br>
    ...
    <tr class="tdbg"> 
      ...
      <td><textarea name="title_righttxt" cols="41" rows="4" id="textarea8"><%=Skin_CSS(18)%></textarea></td>
    </tr>
    <tr class="tdbg"> 
      ...
      <td><textarea name="Title_Right" cols="41" rows="4" id="Title_Right"><%=Skin_CSS(19)%></textarea></td>
    </tr>
    <tr class="tdbg"> 
      ...
      <td><textarea name="tdbg_right" cols="41" rows="4" id="textarea17"><%=Skin_CSS(20)%></textarea></td>
    </tr>
    <tr class="tdbg"> 
      ...
      <td><textarea name="Title_Right2" cols="41" rows="4" id="textarea16"><%=Skin_CSS(21)%></textarea></td>
    </tr>
    <tr class="tdbg"> 
      ...
      <td><textarea name="tdbg_right2" cols="41" rows="4" id="textarea18"><%=Skin_CSS(22)%></textarea></td>
    </tr>
    <tr class="tdbg"> 
      ...
      <td><textarea name="tdbg_rightall" cols="41" rows="4" id="textarea10"><%=Skin_CSS(23)%></textarea></td>
    </tr>
