...
dim ArticleID,Product_Id,BigClassName,SmallClassName,Title,Content,UpdateTime,Hits
...
Buy_price=FormatNumber(request.form("Buy_price"),1,-1)
Product_Gain=FormatNumber(request.form("Product_Gain"),2,-1)
...
price=FormatNumber((Product_Gain+1)*Buy_price,1,-1)
    ...
    <td width="862" align="center" valign="top"> <br> <br> <b> </b><br> <br> <br> 
      <table class="border" align=center width="70%" border="0" cellpadding="0" cellspacing="2" bordercolor="#999999">
        ...
        <tr> 
          ...
          <td width="76%" bgcolor="#E3E3E3" class="tdbg"><%=ArticleID%></td>
        </tr>
        <tr> 
        ...
        <tr> 
          <td height="22" bgcolor="#C0C0C0" class="tdbg"><div align="right">产品进价：</div></td>
          <td bgcolor="#E3E3E3" class="tdbg"><%=Buy_Price%></td>
        </tr>
        <tr> 
        ...
        <tr> 
          <td height="22" colspan="2" bgcolor="#E3E3E3" class="tdbg"> <p align="center"> 
              【<a href="ProductModify.asp?ArticleID=<%=ArticleID%>">修改产品</a>】&nbsp;【<a href="ProductAdd.asp">继续添加产品</a>】&nbsp;【<a href="ProductManage.asp">产品管理</a>】&nbsp;【<a href="../ProductShow.asp?ArticleID=<%=ArticleID%>" target="_blank">预览产品内容</a>】</p></td>
        </tr>
      </table></td>
  </tr>
</table>
