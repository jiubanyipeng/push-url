  ...
  <tr> 
	...
	<br>
      ...
      <table width="550" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td height="25"> <div align="center"><strong>企业形象管理<br>
              <br>
              </strong></div></td>
        </tr>
        <tr> 
...
%>
                <tr bgcolor="#E3E3E3"> 
                  ...
                  <td bgcolor="#E3E3E3"> <div align="center"><a href="Manage_editImg.asp?id=<%=rs("id")%>">修改</a></div></td>
                  <td> <div align="center"><a href="Manage_Img.asp?id=<%=rs("id")%>&no=eshop">删除</a></div></td>
                </tr>
                <% 
i=i+1 
