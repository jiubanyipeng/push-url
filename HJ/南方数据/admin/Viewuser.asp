	...
	<br>
      ...
      <table border="0" cellpadding="0" cellspacing="0" width="550" bordercolor="#FFFFFF" bordercolorlight="#FFFFFF" bordercolordark="#FFFFFF" class=ver>
        <tr> 
          ...
          <td height="25" colspan="4"  class="ver"> <font class=ver>共有[<font color="#ff0000"><%=rs.recordcount%></font>]Email地址 
            以下是[<font color="red">1～<%=rs.recordcount%></font>]个&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="adduser.asp">添加邮件地址</a></font></td>
        </tr>
        <tr> 
      ...
      <table border="0" cellspacing="2" cellpadding="0" width="550">
        <tr bgcolor="#C0C0C0"> 
          ...
          <td width="31%"> <p align="center"><font color="#000000">邮件地址</font></td>
          <td colspan="3"  class=ver> <p align="center"><font color="#000000">用户名</font></td>
          <td  width="16%"> <p align="center"><font color="#000000">- 删除 - </font> 
          </td>
        </tr>
        <% do while not rs.eof %>
        <tr bgcolor="#E3E3E3"> 
          ...
          <td width="16%" > <p align="center"><font color="#000000">[<a href="viewuser.asp?del=<%=rs("id")%>"><font class=ver>删除</font></a>]</font> 
            </p></td>
        </tr>
        <% i=i+1                                                                                                  
          rs.movenext                                                                                                  
