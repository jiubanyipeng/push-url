...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td align="center" valign="top"><br>
            <a href="Down_ClassAddBig.asp"><strong><font color="#FF0000"><u>添加下载一级分类</u></font></strong></a><br>
      <br> 
...
%>
        <tr bgcolor="#E3E3E3" class="tdbg"> 
          ...
          <td align="right" bgcolor="#C0C0C0" style="padding-right:10"><a href="Down_ClassAddSmall.asp?BigClassName=<%=rsBigClass("BigClassName")%>"><font color="#FF0000">添加二级分类</font></a> 
	...
	%>
        <tr bgcolor="#EAEAEA" class="tdbg"> 
          ...
          <td align="right" style="padding-right:10"><a href="Down_ClassModifySmall.asp?SmallClassID=<%=rsSmallClass("SmallClassID")%>">修改</a> 
