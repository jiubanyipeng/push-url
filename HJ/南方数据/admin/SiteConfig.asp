...
<form method="POST" action="SiteConfig.asp" id="form" name="form">
  <table width="600" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#ECF5FF" class="table_southidc">
    <tr> 
      <td class="back_southidc" colspan="4"> <div align="center"><strong>网 站 配 
          置</strong></div></td>
    </tr>
    <tr> 
    ...
    <tr> 
      <td width="224" height="20" class="tdbg"><strong>首页Banner地址(只能用FLASH)：</strong><br> </td>
    ...
    <tr> 
      <td class="tdbg"><strong>产品内容是否分页显示：</strong></td>
      <td colspan="3" class="tdbg"> <input type="radio" name="ShowContentByPage" value="Yes" <%if ShowContentByPage="Yes" then response.write "checked"%>>
    ...
    <tr> 
      <td class="tdbg"><strong>是否弹出公告窗口：</strong></td>
    ...
    <tr> 
      <td width="224" class="tdbg"><strong>SMTP登录密码：</strong><br>
        当你的服务器需要SMTP身份验证时还需设置此参数 </td>
      <td colspan="3" class="tdbg"> <input name="MailServerPassWord" type="text" id="MailServerPassWord" value="<%=MailServerPassWord%>" size="40"> 
      </td>
    </tr>
    <tr> 
