...
if (confirm("真的要删除这个询价?"))
window.location.href="Admin_OrderDel.asp?id="+id+"&page="+page
}
</script>
...
%>
              <tr bgcolor="#ECF5FF"> 
                ...
                <td> 
                  <div align="center"> 
                    <%response.write "<a href='Admin_OrderDetail.asp?ID="&rs("OrderNum")&"&page="&CurrentPage&"'  >详细资料</a>"
%>
                  </div></td>
                <td> 
                  <div align="center"> 
