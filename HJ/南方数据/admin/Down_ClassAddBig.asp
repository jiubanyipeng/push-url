...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    <td align="center" valign="top"> <br>
            <a href="Down_ClassManage.asp"><strong>下 载 类 别 设 置</strong></a> <br>
      <form name="form1" method="post" action="Down_ClassAddBig.asp" onsubmit="return checkBig()">
        <table width="350" border="0" align="center" cellpadding="0" cellspacing="2" class="border">
          <tr bgcolor="#999999" class="title"> 
                  <td height="25" colspan="2" align="center"><strong>下载大类</strong></td>
          </tr>
          <tr bgcolor="#E3E3E3" class="tdbg"> 
            <td width="126" height="22" bgcolor="#C0C0C0"> <div align="right"><strong>下载名称：</strong></div></td>
