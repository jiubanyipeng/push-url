...
<table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
	...
	<br>
      <br>
      <b> </b><br>
      <p align="center"><strong>下 载 管 理</strong></p>
...
%>
      ...
      <form name="del" method="Post" action="Down_ArticleDel.asp" onsubmit="return ConfirmDel();">
        <table width="620" border="0" cellpadding="0" cellspacing="2">
          <tr> 
            <td height="25" bgcolor="#CCCCCC"><a href="Down_Manage.asp">&nbsp;下载资讯管理</a> 
              &gt;&gt; 
              <%
...
%>
        <table class="border" border="0" cellspacing="2" width="620" cellpadding="0" style="word-break:break-all">
          <tr bgcolor="#C0C0C0" class="title"> 
            ...
            <td width="246" align="center" bgcolor="#C0C0C0" >下载标题</td>
          ...
          <tr class="tdbg"> 
            ...
            <td width="68" align="center" bgcolor="#E3E3E3"> <a href="Down_admin_modi.asp?ID=<%=rs("id")%>">修改</a> 
              <a href="Down_admin_del.asp?ID=<%=rs("ID")%>&Action=Del" onclick="return ConfirmDel();">删除</a> 
            </td>
          </tr>
          <%
	i=i+1
