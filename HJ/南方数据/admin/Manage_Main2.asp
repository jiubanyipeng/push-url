...
<%Wenhua=server.htmlencode(Trim(Request("content"))) %>
...
rs.update
rs.close
response.redirect "Manage_Main2.asp"
end if
sql="select * from main"
  ...
  <tr> 
	...
	<br>
      ...
      <table width="550" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td height="25">
<div align="center"><strong>公 司 文 化 设 置</strong></div></td>
        </tr>
        <tr> 
          <form method="POST" action="Manage_Main2.asp?no=eshop">
...
Wenhua=replace(rs_home("Wenhua"),"<br>",chr(13))
Wenhua=replace(Wenhua,"&nbsp;"," ")
else
Wenhua=rs_home("Wenhua")
end if
response.write Wenhua%></textarea> </td>
                </tr>
                <tr> 
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
