...
<center>
              <TABLE width=95% align="center" cellSpacing=1 bgColor=#666666 >
                <TBODY> 
                  <TR bgColor=#999999> 
                    <TD height="22"  colSpan=2> <div align="center"><font color="#FFFFFF">购物结算--(第二步)购物信息及付款方式</font> 
                      </div></TD></TR>
                  <tr bgcolor="#F0FCFF"> 
...
<tr>  
                    <TD  width=250 bgcolor=#F0FCFF height=7>我们提供三家银行的账号供您汇款,请您选择:</TD>  
...
<tr> 
                    <TD  width=250 bgcolor=#F0FCFF height=7>订单备注:
<p>　</p>
</TD>
                    <TD  width=501 height=7 bgcolor="#F0FCFF">
