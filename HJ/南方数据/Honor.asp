...
<TABLE width="760" border=0 align="center" cellPadding=0 cellSpacing=0 bgcolor="#FFFFFF">
  <TBODY>
    <TR> 
      <TD width=196 vAlign=top bgcolor="#FFFFFF"> <table width="93%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
          <tr> 
            <td width="182" valign="top"> <TABLE width="99%" border=0 cellPadding=0 cellSpacing=0 background="Img/index_01b.gif">
                <TBODY>
                  <TR> 
          ...
          <TBODY>
            ...
            <TR> 
              <TD colspan="3"> <TABLE cellSpacing=0 cellPadding=0 width="555" border=0>
                  <TBODY>
                    <TR> 
                      <TD height="25"><img src="Img/bgtop_14.gif" width="557" height="37"></TD>
                    </TR>
                  </TBODY>
                </TABLE></TD>
            </TR>
                  ...
                  <TR> 
                    ...
                    <TD> <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      width=10>&nbsp;</TD>
                        ...
                        href=imagebig_honor.asp?id=<%=rs("id")%> target=_blank><img src="<%=rs("img")%>" alt="" width="150" height="180" border="0"></a></TD>
