      ...
      <TD valign="top"> 
        <TABLE width="90%" border=0 align="right" cellPadding=0 cellSpacing=0>
          <TBODY>            
            ...
            <TR> 
              <TD valign="top"><img src="Img/buttonjk.gif" width="557" height="37"> 
              </TD>
            </TR>
            <TR> 
            ...
            <TR> 
                  ...
                  <tr> 
                        <td width="18%" height="18" bgcolor="#eeeeee">&nbsp; 首页》业内资讯</td>
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="3" bgcolor="#FBFEFF">
                  ...
                  <tr> 
                        <td> 
                          <script language="javascript" src="owen.asp?owen1=业内资讯&n=20"></script></td>
                  </tr>
                
                  <tr> 
                        <td height="8"><div align="right"><a href="otype.asp?owen1=业内资讯">更多>>></a></div></td>
                  </tr>
                </table>
                <table width="100%" height="19" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr> 
                        <td width="18%" height="18" bgcolor="#eeeeee">&nbsp;</td>
                        <td width="82%" bgcolor="#eeeeee">&nbsp; </td>
                  </tr>
                  <tr> 
                    <td height="1" colspan="2" bgcolor="#999999"></td>
